...
export const DEFAULT_RING_CONFIG: RingConfig = {
  ...
  breakpoints: [
    { hoursIn: 12, icon: BloodSugarDrop, effectCode: 'bloodSugarDrop', colorCode: '#D8362A' },
    { hoursIn: 14, icon: FatBurning, effectCode: 'fatBurning', colorCode: '#D8362A' },
    { hoursIn: 16, icon: Autophagy, effectCode: 'autophagy', colorCode: '#D8362A' },
    { hoursIn: 48, icon: GrowthHormone, effectCode: 'growthHormone', colorCode: '#D8362A' },
    { hoursIn: 56, icon: InsulinDrop, effectCode: 'insulinDrop', colorCode: '#D8362A' },
    { hoursIn: 72, icon: ImmuneReset, effectCode: 'immuneReset', colorCode: '#E4E4E9' },
  ],
};
